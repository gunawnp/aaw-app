        ...
        @if (!$done)
            <div class="fs-6 lh-lg text-justify me-4">
                <div class="mb-5">
                    ...
                    <p>
                        Setelah melakukan tes gaya belajar dan tes tingkatan berpikir logis selanjutnya Anda akan mengerjakan pretest asesmen adaptif dengan mata pelajaran struktur percabangan dan struktur perulangan. Hasil tes ini dapat dibagikan kepada guru, orang tua, pembimbing, dan fasilitator komunitas lainnya.
                    </p>
                    <p>
...
int main() {
	...
	return 0;
                        ...
                        <form method="post" action="/home/pretest" id="myform" class="d-md-flex justify-content-center">
                            @csrf
